...
(function (root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Texpigg = factory(root.KaitaiStream);
  }
}(this, function (KaitaiStream) {
var Texpigg = (function() {
  function Texpigg(_io, _parent, _root) {
    this._io = _io;
  ...
  Texpigg.prototype._read = function() {
  ...
  var FileHeader = Texpigg.FileHeader = (function() {
    ...
    Object.defineProperty(FileHeader.prototype, 'value', {
      get: function() {
        ...
        this._m_value = new Texture(_io__raw__m_value, this, this._root);
        this._m_value._read();
  ...
  var Texture = Texpigg.Texture = (function() {
    ...
    Texture.prototype._read = function() {
      ...
      this._unnamed0 = this._io.readBytes(32);
      ...
      this._debug.dds = { start: this._io.pos, ioOffset: this._io.byteOffset };
      this.dds = this._io.readBytesFull();
      this._debug.dds.end = this._io.pos;
    }

    return Texture;
  })();

  var Strings = Texpigg.Strings = (function() {
  ...
  var U4string = Texpigg.U4string = (function() {
